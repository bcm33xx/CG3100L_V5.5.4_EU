...
typedef void (*cyg_scheduler_context_switch_callout)(
   CYG_ADDRWORD   previous_thread_handle,
   cyg_uint16     previous_thread_id,
   CYG_ADDRWORD   next_thread_handle,
...
public:
   ...
   // to NULL to disable the callout.
    static void register_context_switch_callout(
...
private:
    ...
    static cyg_scheduler_context_switch_callout  context_switch_callout;
...
public:
    ...
    void own_mutex( Cyg_Mutex *mutex );

    // Release this mutex from our list.
    void disown_mutex( Cyg_Mutex *mutex );
