    ...
    : public Cyg_Scheduler_Base
{
    ...
    cyg_uint32 pending[HAL_SMP_CPU_MAX][CYGNUM_KERNEL_SCHED_PRIORITIES];

    cyg_sched_bitmap pending_map[HAL_SMP_CPU_MAX];
...
protected:
    ...
    HAL_SMP_CPU_TYPE    cpu;            // CPU id of cpu currently running
                                        ...
                                        // if not running.
    cyg_ucount32        cpu_affinity;   // CPU affinity bits mask.
