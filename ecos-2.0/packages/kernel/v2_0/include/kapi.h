...
/* Context switch handler function prototype. */
typedef void (*cyg_scheduler_context_switch_callout_t)(
   cyg_handle_t   previous_thread_handle,
   cyg_uint16     previous_thread_id,
   cyg_handle_t   next_thread_handle,
   cyg_uint16     next_thread_id
);
...
void cyg_scheduler_register_context_switch_callout
(
   cyg_scheduler_context_switch_callout_t    new_callout,
   cyg_scheduler_context_switch_callout_t   *old_callout
);
...
cyg_bool_t cyg_thread_set_affinity( cyg_handle_t thread, cyg_uint32 affinity_mask );

cyg_uint32 cyg_thread_get_affinity( cyg_handle_t thread );
