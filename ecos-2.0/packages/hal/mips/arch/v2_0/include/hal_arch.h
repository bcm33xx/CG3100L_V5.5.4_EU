...
#define CYGNUM_HAL_STACK_SIZE_TYPICAL (CYGNUM_HAL_STACK_SIZE_MINIMUM+4096)
...
//--------------------------------------------------------------------------
// Dynamic memory allocation region size finder

#if CYGINT_HAL_MIPS_MEM_REAL_REGION_TOP

externC cyg_uint8 *hal_mips_mem_real_region_top( cyg_uint8 *_regionend_ );
                                                
# define HAL_MEM_REAL_REGION_TOP( _regionend_ ) \
    hal_mips_mem_real_region_top( _regionend_ )
#endif
