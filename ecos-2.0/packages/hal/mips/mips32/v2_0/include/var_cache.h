...
extern int hal_icache_linesize;
extern int hal_icache_assoc;
extern int hal_icache_sets;
extern int hal_icache_lines;
extern int hal_icache_size;

extern int hal_dcache_linesize;
extern int hal_dcache_assoc;
extern int hal_dcache_sets;
extern int hal_dcache_lines;
extern int hal_dcache_size;


// Data cache
#define HAL_DCACHE_SIZE                 hal_dcache_size         // Size of data cache in bytes
#define HAL_DCACHE_LINE_SIZE            hal_dcache_linesize     // Size of a data cache line
#define HAL_DCACHE_WAYS                 hal_dcache_assoc        // Associativity of the cache

// Instruction cache
#define HAL_ICACHE_SIZE                 hal_icache_size         // Size of cache in bytes
#define HAL_ICACHE_LINE_SIZE            hal_icache_linesize     // Size of a cache line
#define HAL_ICACHE_WAYS                 hal_icache_assoc        // Associativity of the cache

#define HAL_DCACHE_SETS                 hal_dcache_sets
#define HAL_ICACHE_SETS                 hal_icache_sets
