...
static bcm33xx_serial_info bcm33xx_serial_info0 = { 0, UART0_IRQ_BIT, bcm33xx_default_break_callout };
...
static bcm33xx_serial_info bcm33xx_serial_info1 = { 0, UART1_IRQ_BIT, NULL };
...
//    UART->baudword = 1;
    ...
    if (initialize) {
        ...
        if (chan->out_cbuf.len != 0) {
            ...
            hal_enable_periph_interrupt( bcm33xx_chan->interruptNumber );
        } else {
            UART->intEnableMask = 0;
        }
    } else {
...
bcm33xx_serial_init(struct cyg_devtab_entry *tab)
{
    ...
    if (chan->out_cbuf.len != 0) {
        ...
        hal_map_periph_interrupt(    bcm33xx_chan->interruptNumber, bcm33xx_serial_ISR, (void *) chan );
        hal_enable_periph_interrupt( bcm33xx_chan->interruptNumber );
    }
